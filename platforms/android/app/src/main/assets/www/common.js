...
var CrudService = /** @class */ (function () {
    ...
    CrudService.prototype.create_NewStudent = function (record) {
        return this.firestore.collection('Users').add(record);
    };
    CrudService.prototype.read_Students = function () {
        return this.firestore.collection('Users').snapshotChanges();
    };
    CrudService.prototype.update_Student = function (recordID, record) {
        this.firestore.doc('Users/' + recordID).update(record);
    };
    CrudService.prototype.delete_Student = function (record_id) {
